 ...
 */
public class OyenteEditarComentario {
    /**
     ...
     */
    private IObservadorEditarComentario observador;
    /**
     * Método constructor de la clase.
     * @param observador Observador del evento.
     */
    public OyenteEditarComentario(IObservadorEditarComentario observador){
        try{
    ...
    private void registrarObservador(){
        Solicitud solicitud= new Solicitud(Operacion.suscribir_observador_editarComentario);
    ...
    public void eliminarObservador(){
        Solicitud solicitud= new Solicitud(Operacion.desuscribir_observador_editarComentario);
        String mensaje= Deserealizador.getInstancia().serializarSolicitud(solicitud);
        this.enviarMensaje(mensaje);
    }
    /**
            ...
            public void run(){
                ...
                while(socket.isConnected()){
                    try{
                        ...
                        observador.notificarEdicionComentario(Deserealizador.getInstancia().deserealizarComentario(mensajeOyenteBroker));
                    } catch (IOException e){
                        cerrarTodo(socket, bufferedReader, bufferedWriter);
                    }
                }
